...
logger.info("Initializing Return Prevention Engine Microservice...")

# Initialize FastAPI App
app = FastAPI(
    title="Return Prevention Engine",
    description="S1 Microservice in VPC-1 Intelligence Layer. Predicts return risk and recommends pre-purchase actions.",
    version="1.0.0",
    docs_url="/docs",
