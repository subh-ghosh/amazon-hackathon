...
logger.info("Initializing Packaging Intelligence Service...")

# Initialize FastAPI App
app = FastAPI(
    title="Packaging Intelligence Service",
    description="S10 Microservice in VPC-1 Intelligence Layer. Analyzes packaging sustainability, efficiency, recyclability, and carbon impact.",
    version="1.0.0",
    docs_url="/docs",
...
if __name__ == "__main__":
    import uvicorn
    # Start the server locally on port 8010
